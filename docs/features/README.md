...
- ✅ UX0001: `tests/ux/UX0001.test.tsx` - 查看學習統計
- ✅ UX0002: `tests/ux/UX0002.test.tsx` - 開始複習挑戰
- ✅ UX0003: `tests/ux/UX0003.test.tsx` - 導航到字庫管理
- ✅ UX0004: `tests/ux/UX0004.test.tsx` - 手動觸發雲端同步
...
- ✅ UX0005: `tests/ux/UX0005.test.tsx` - 切換標籤頁
- ✅ UX0006: `tests/ux/UX0006.test.tsx` - 搜尋單字
- ✅ UX0007: `tests/ux/UX0007.test.tsx` - 篩選單字
- ✅ UX0008: `tests/ux/UX0008.test.tsx` - 排序單字
- ✅ UX0009: `tests/ux/UX0009.test.tsx` - 查看單字卡詳情
- ✅ UX0010: `tests/ux/UX0010.test.tsx` - 刪除單字卡
- ✅ UX0011: `tests/ux/UX0011.test.tsx` - 手動輸入單字
- ✅ UX0012: `tests/ux/UX0012.test.tsx` - 圖片上傳與識別
- ✅ UX0013: `tests/ux/UX0013.test.tsx` - AI 分析單字
- ✅ UX0014: `tests/ux/UX0014.test.tsx` - 預覽單字卡
- ✅ UX0015: `tests/ux/UX0015.test.tsx` - 儲存新單字卡
...
- ✅ UX0016: `tests/ux/UX0016.test.tsx` - 選擇學習 Level
- ✅ UX0017: `tests/ux/UX0017.test.tsx` - 選擇語音
- ✅ UX0018: `tests/ux/UX0018.test.tsx` - 學習模式 - 查看單字卡
- ✅ UX0019: `tests/ux/UX0019.test.tsx` - 學習模式 - 切換音節顯示
- ✅ UX0020: `tests/ux/UX0020.test.tsx` - 學習模式 - 播放語音
- ✅ UX0021: `tests/ux/UX0021.test.tsx` - 學習模式 - 翻轉卡片
- ✅ UX0022: `tests/ux/UX0022.test.tsx` - 學習模式 - 切換到下一個單字
- ✅ UX0023: `tests/ux/UX0023.test.tsx` - 積木模式 - 播放語音
- ✅ UX0024: `tests/ux/UX0024.test.tsx` - 積木模式 - 重組字母
- ✅ UX0025: `tests/ux/UX0025.test.tsx` - 積木模式 - 檢查答案
- ✅ UX0026: `tests/ux/UX0026.test.tsx` - 聽寫模式 - 播放語音
- ✅ UX0027: `tests/ux/UX0027.test.tsx` - 聽寫模式 - 輸入單字
- ✅ UX0028: `tests/ux/UX0028.test.tsx` - 聽寫模式 - 檢查答案
...
- ✅ UX0029: `tests/ux/UX0029.test.tsx` - 查看單字卡正面
- ✅ UX0030: `tests/ux/UX0030.test.tsx` - 翻轉單字卡查看背面
- ✅ UX0031: `tests/ux/UX0031.test.tsx` - 查看單字分析資訊
...
詳細的測試對應表請參考：`docs/testing/ux-test-mapping.md`
...
3. **新增或更新對應的測試檔案**（`tests/ux/UX####.test.tsx`）
4. 列出相關的 UI 元素
5. 標註所有相關的程式碼檔案
6. 說明關鍵功能點
7. 更新「常見任務與對應檔案」區段（如適用）
8. 更新測試狀態資訊
